...
Since $F_0$ = `r F_0` is much less than $F_c$ = `r F_c`, I reject the null hypothesis about the null model.
...
$\beta_0 = 0.59755$ means with every unit increase in income (one thousand dollar) and keeping all the other variables constant, the person will have $\beta_0 = 0.59755$ unit increase in prestige.

$\beta_0 = 0.34532$ means with every unit increase in education (years) and keeping all the other variables constant, the person will have $\beta_0 = 0.34532$ unit increase in prestige.
...
$\gamma_0 = -14.66113$ indicates, for white collar occupation, compared to blue collar,  the value of prestige will increase when the income and education are all zeros. 
